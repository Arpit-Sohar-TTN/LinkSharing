 ...
 */
body {
	background: url(../assets/images/forgetPassword.png);
...
<div class="wrap">
	...
	<!--start-content------>
	<div class="content">
		<g:img dir="assets/images" file="forgetPassword.png"/>
		<p><span><label>O</label>hh.....</span>Your new password has been mailed to you kindly check your email-id</p>
