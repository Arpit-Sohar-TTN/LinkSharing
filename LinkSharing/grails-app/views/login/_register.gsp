<div class="panel panel-default"><!--topPosts-->
	...
	<div class="panel-body">
		<g:uploadForm class="" method="post" controller="login" action="register">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="userName" id="username"
						       pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" required="true"
		...
		%{--<input id="input-1a" type="file" class="file" data-show-preview="false">--}%
			<g:field id="input-1a" type="file" name="image" accept="image/*" class="file" data-show-preview="false"/><br/>
