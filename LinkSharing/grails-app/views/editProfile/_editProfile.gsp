	...
	<div class="panel-body" style="padding: 10px">
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
						<input type="text" class="form-control" name="lastName" pattern="^[a-zA-Z]*$" value="${session.user.lastName}" required="true"
			...
			<div class="form-group">
				...
				<div class="cols-sm-10">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="userName" value="${session.user.userName}" required="true"
