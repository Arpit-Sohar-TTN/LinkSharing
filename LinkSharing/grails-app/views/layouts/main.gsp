...
<nav class="navbar navbar-default " style="background-color:    #4CAF50    ;margin-bottom: 20px ">
	...
	<div class="navbar-header">
		...
		<asset:image src="logo.png" href="/user/index" class="logo pull-left"
		             style="height: 45px;width: 40px;padding-top: 10px"></asset:image>
		<a class="navbar-brand" href="/user/index" style="padding-left: 30px; color: black;">Link Sharing</a>
	</div>
			...
			<g:if test="${session.getAttribute('user')}">
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
					   aria-expanded="false" style="color: black"><span class="caret"></span> &nbsp; ${session.user.userName}</a>
		...
		<form class="navbar-form navbar-right" style="margin-right: 10px" action="/user/search">
			...
			%{--<input type="submit" value="search"/>--}%
				...
				<g:if test="${session.getAttribute('user')}">
					...
					<a href="#" data-toggle="modal"><span class=" glyphicon glyphicon-user redfamily pull-right"
					                                      style="font-size: 2em;margin-top: 10px;margin-left: 40px;margin-right: -20px"></span>
					</a>
					<a href="#shareDocuments" data-toggle="modal"><span
							class=" glyphicon glyphicon-file redfamily pull-right"
							style="font-size: 2em;margin-top: 10px;margin-left: 10px"></span></a>
					<a href="#shareLink" data-toggle="modal"><span
							class=" glyphicon glyphicon-paperclip redfamily pull-right"
							style="font-size: 2em;margin-top: 4px;margin-left: 10px"></span></a>
					<a href="#sendInvitation" data-toggle="modal"><span
							class=" glyphicon glyphicon-envelope redfamily pull-right"
							style="font-size: 2em;margin-top: 10px;margin-left: 10px"></span></a>
					<a href="#createTopic" data-toggle="modal"><span class=" fa fa-comment redfamily pull-right"
					                                                 style="font-size: 2em;margin-top: 10px;margin-left: 10px"></span>
					</a>
				</g:if>
			</div>
