	...
	<g:each in="${subscribedUsers}" var="subscribedUser">
		...
		<div class="panel-body">
			<div class="col-md-3 col-xs-12">
				...
				<ls1:userImage userId="${subscribedUser.user.id}"/>
			</div>

			<div class="col-md-9 col-xs-12 center-block">
				<div class="row"><!--username-->
					<div class="col-xs-6 col-md-6"><!--username-->
						<b class=""></b> <g:link controller="user" action="showProfile"
						                         params="[userName: subscribedUser.user.userName]"><i>@${subscribedUser.user.userName}</i></g:link>
					</div><!--./username-->
				</div><!--/.username-->
				<div><!--content-->
					<br/>
